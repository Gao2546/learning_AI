...
def train_ddp(rank, world_size, train_dataset, batch_size, model_ckp, model_VQVAE, model_CLIP,trainVQVAE,n_epoch,img_size,image_c,Text_dim,No_VQVAE,n_class):
...
def main():
    ...
    model_CLIP = None#"model/checkpoint/CLIP0.pth"
    ...
    mp.spawn(train_ddp, args=(world_size, train_dataset, batch_size, model_ckp, model_VQVAE_path,model_CLIP,traning_VQVAE,epochs,size,image_c,Text_dim,No_VQVAE,n_class), nprocs=world_size, join=True)
