    ...
    def train(self):
        ...
        for epoch in tqdm(range(self.start_epoch,self.epochs)):
            ...
            if self.save and (((epoch + 1) % self.save_every_epoch) == 0):
                ...
                self.save_model_and_optimizer(self.save_dir + f"Transformers04_{epoch + 1:0=5}.pth")
...
class Transformer:
    def __init__(self): #loss == 0.02 0.006
        ...
        self.data_path = "./data/PythonCodeDataSmall_TextOnly/Python_code_data2ex.txt"
        ...
        self.save_file = "Transformer_V01_128_512_12_12_2048_10K_MQ.pth"
        #======================================================================================
        # self.load_path = None#"./model/Transformer/Transformer_V01_10KC.pth" #DGood For Traning set
        # self.save_file = "Transformer_VT01_10KA.pth"
